	...
	public function shopMenu()
	{
		...
		$shopmenu_2 = array(
			...
			'goods'       => array(
				...
				'items'    => array(
                        ...
                        array(
                            ...
                            'route' => 'goods/config',
                            'items' => array(
                                array('title' => '套餐列表', 'route' => 'packages/index'),
                                array('title' => '兑换券列表', 'route' => 'coin/index'),
                            ),
                        ),
					)
			),
			'order'       => array(
				...
				'route' => 'order/index',
				'items'    => array(
					array('title' => '普通订单', 'route' => 'order/index', 'desc' => ''),
                    array('title' => '套餐订单', 'route' => 'packages/order', 'desc' => ''),
                    array('title' => '卡券订单', 'route' => 'coin/buyorder', 'desc' => '卡券订单'),
				    array('title' => '拼团订单', 'route' => 'group/orderlist', 'desc' => ''),
				    array('title' => '积分订单', 'route' => 'points/order', 'desc' => ''),
...
//				            array('title' => '订单管理', 'route' => 'distribution/distributionorder', 'desc' => ''),
		    ...
		    'article' 	=> array(
		        ...
		        'items'    => array(
                    ...
                    array('title' => '文章分类', 'route' => 'article/category', 'desc' => ''),
		        )
		    ),
            'business' 	=> array(
                'title'    => '商圈',
                ...
                'items'    => array(
                    array('title' => '商圈列表', 'route' => 'business/index', 'desc' => ''),
                    array('title' => '商圈分类', 'route' => 'business/category', 'desc' => ''),
                )
            ),
					...
					array( 
						...
						array(
							...
							'items' => array(
                                ...
                                array('title' => '积分清零', 'route' => 'user/integral_clear', 'desc' => ''),
							)
						),
                        ...
                        array(
                            ...
                            'route' => 'marketing/recharge',
                            'items' => array(
                                array('title' => '活动列表', 'route' => 'marketing/lottery_category', 'desc' => ''),
                                array('title' => '奖品设置', 'route' => 'marketing/lottery', 'desc' => ''),
                                array('title' => '抽奖设置', 'route' => 'marketing/lottery_config', 'desc' => ''),
                                array('title' => '中奖纪录', 'route' => 'marketing/lottery_list', 'desc' => ''),
                            )
                        ),
						array(
					 	'title' => '付费会员卡',
				...
				'items'    => array(
					...
					array(
						...
						'items' => array(
							...
							array('title' => '公告列表', 'route' => 'configindex/notice', 'desc' => ''),
							...
							array('title' => '视频设置', 'route' => 'configindex/video', 'desc' => ''),
                            array('title' => '海报专场', 'route' => 'configindex/posterlist', 'desc' => ''),
                            array('title' => '海报列表', 'route' => 'configindex/poster', 'desc' => ''),
						    array('title' => '广告列表', 'route' => 'configindex/advertisementlist', 'desc' => ''),
						)
					),
					...
					array(
						...
						'items' => array(
                            ...
                            array('title' => '满额包邮', 'route' => 'express/fullfree', 'desc' => ''),
						)
					),
					array(
						'title' => '个人中心',
			...
			'generalmall'  => array(
				...
				'items'    => array(
					array('title' => 'vip幻灯片', 'route' => 'generalmall/slider', 'desc' => ''),
//					array('title' => '导航图标', 'route' => 'generalmall/navigat', 'desc' => ''),
			...
			'myxdefine'  => array(
				...
				'subtitle' => '自定义管理',
				'icon'     => 'setup',
				'route' => 'myxdefine/slider',
				'items'    => array(
					array('title' => '综合菜单', 'route' => 'generalmall/slider', 'desc' => ''),
//					array('title' => '导航图标', 'route' => 'generalmall/navigat', 'desc' => ''),
				),
			),
		);	
