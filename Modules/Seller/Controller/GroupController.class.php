...
class GroupController extends CommonController{
	...
	public function editgoods()
	{
		...
		if (IS_POST) {
			...
			sellerLog('编辑了拼团商品[' . $goods['goodsname'] . '(' . $goods['id'] . ')]', 3);
	...
	public function addgoods()
	{
		if (IS_POST) {
			...
			$http_refer = empty($http_refer) ? $_SERVER['HTTP_REFERER'] : $http_refer;
			sellerLog('新增拼团商品[' . I('post.goodsname', '', 'trim') . ']', 3);
	...
	public function pintuan_detail()
	{
		...
		{
			$weqrcode = D('Home/Pingoods')->_get_commmon_wxqrcode('community/moduleA/pin/share', $pin_info['order_id'] );
