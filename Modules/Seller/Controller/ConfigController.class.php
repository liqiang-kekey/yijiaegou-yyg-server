...
class ConfigController extends CommonController{
	...
	public function index()
	{
		if (IS_POST) {
            ...
            $data['integral_clear'] = md5(trim($data['integral_clear']));
	...
	public function picture()
	{
		...
		if (IS_POST) {
			...
			//index_header_text_backgroundimage
			$data['index_header_text_backgroundimage'] = save_media($data['index_header_text_backgroundimage']);
			//index_header_zhibo_image
			$data['index_header_zhibo_image'] = save_media($data['index_header_zhibo_image']);
			//溯源摄像头图片
			$data['suyuan_image1'] = save_media($data['suyuan_image1']);
			$data['suyuan_image2'] = save_media($data['suyuan_image2']);
			$data['suyuan_image3'] = save_media($data['suyuan_image3']);
			//
