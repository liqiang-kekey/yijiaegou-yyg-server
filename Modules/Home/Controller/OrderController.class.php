...
class OrderController extends CommonController {
	...
	**/
		...
		if( $order_info['order_status_id'] == 1)
		{
			...
			if( empty($order_can_del_cancle) || $order_can_del_cancle == 0 )
			{
				...
				if( !empty($weixin_template_cancle_order) && !empty($platform_send_info_member_id) )
				{
					...
					{
						$head_pathinfo = "community/pages/index/index";
	...
	public function orderlist()
	{
	    ...
	    $sql = "select o.order_id,o.order_num_alias,o.date_added,o.delivery,o.is_pin,{$fields} o.is_zhuli,o.shipping_fare,o.shipping_tel,o.shipping_name,o.voucher_credit,o.score_for_money,o.fullreduction_money,o.store_id,o.total,o.order_status_id,o.lottery_win,o.type,os.name as status_name,o.ziti_mobile from ".C('DB_PREFIX')."lionfish_comshop_order as o {$left_join}, {$join} 
	   ...
	   $url = D('Home/Front')->get_config_by_name('shop_domain');
	    ...
	    foreach($list as $key => $val)
	    {
			...
			$goods_list = M('lionfish_comshop_order_goods')->field('order_goods_id,head_disc,member_disc,level_name,goods_id,is_pin,shipping_fare,name,goods_images,quantity,price,total,fullreduction_money,voucher_credit,rela_goodsoption_valueid')->where( array('order_id' => $val['order_id']) )->select();
