		...
		**/
		...
		if($order['is_pin'] == 0)
		{
			...
			foreach($order_goods_list as $order_goods)
			{
				...
				{
					//20201112LQ，根据优化需求，针对余额支付方式，不计算分销金额
			...
			if( $order_info['from_type'] == 'wepro' )
			{
				...
				$pagepath = 'community/pages/order/order?id='.$order['order_id'];
				...
				if(!empty($template_order_success_notice)){
					...
					{
						$head_pathinfo = "community/moduleA/groupCenter/groupDetail?groupOrderId=".$order['order_id'];
