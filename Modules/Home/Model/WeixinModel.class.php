...
class WeixinModel{
...

    {
        ...
        if($total_fee>0){
            ...
            return array('code' => 0, 'msg' =>'订单金额不符');
        }
    }
		...
		else if($refund_fee == 0)
		{
			...
			**/
			...
			if( $order_info['from_type'] == 'wepro' )
			{
				...
				$pagepath = 'community/pages/order/order?id='.$order_info['order_id'];
