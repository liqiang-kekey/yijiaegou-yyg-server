...
class PingoodsModel {
	...
	**/
	...
	public function _get_index_wxqrcode($member_id,$community_id)
	{
		...
		$weqrcode = $jssdk->getAllWeQrcode('community/pages/index/index',$community_id .'_'. $member_id,true,$qrcode_arr);
	...
	public function _get_goods_user_wxqrcode($goods_id,$member_id,$community_id)
	{
		...
		//community/pages/goods/goodsDetail
		if($goods_id == 0)
		{
			$weqrcode = $jssdk->getAllWeQrcode('community/pages/index/index',$goods_id.'_'.$member_id.'_'.$community_id ,false,$qrcode_arr);
		}else{
			...
			if( $gd_info['type'] == 'pin' )
			{
				$weqrcode = $jssdk->getAllWeQrcode('community/moduleA/pin/goodsDetail',$goods_id.'_'.$member_id.'_'.$community_id ,false,$qrcode_arr);
			}else{
				
				$weqrcode = $jssdk->getAllWeQrcode('community/pages/goods/goodsDetail',$goods_id.'_'.$member_id.'_'.$community_id ,false,$qrcode_arr);
			}
